...
interface ILopoLoanInitializer is ILopoLoanEvents {
    /**
     *  @dev   Encodes the initialization arguments for a LopoLoan.
    ...
    /**
     *  @dev   Decodes the initialization arguments for a LopoLoan.
