...
/// @title Refinancer uses storage from a LopoLoan defined by LopoLoanStorage.
contract Refinancer is IRefinancer, LopoLoanStorage {
    ...
    function updateDelegateFeeTerms(uint256 delegateOriginationFee_, uint256 delegateServiceFee_) external override {
        ILopoLoanFeeManager(_feeManager).updateDelegateFeeTerms(delegateOriginationFee_, delegateServiceFee_);
    }
