...
contract Defaults is Constants {
    ...
    uint256 public constant EXPECTED_EXIT_SHARES = 714_285; // ASSETS * (POOL_SHARES + 1) / (POOL_ASSETS - unrealizedLosses + 1) Round down
    ...
    uint256 public constant EXPECTED_EXIT_ASSETS = 1_399_999; // SHARES * (POOL_ASSETS - unrealizedLosses + 1) / (POOL_SHARES + 1) Round down
